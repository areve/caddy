...
func TestVisibleErrorWithPanic(t *testing.T) {
	...
	if !strings.Contains(body, "[PANIC /] middleware/errors/errors_test.go") && !strings.Contains(body, "[PANIC /] src/github.com/mholt/caddy/middleware/errors/errors_test.go") {
